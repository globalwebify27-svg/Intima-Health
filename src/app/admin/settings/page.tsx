    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Manage your system administrator profile credentials and review global settings.
        </p>
      </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full h-11 px-3.5 rounded-xl border border-border bg-transparent text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 pr-10"
                      />
                      <button
                        type="button"
